...
router.get(
  "/empresa-distribuicao/:id",
  empresa_distribuicao_controllers.readOne
);
router.put(
  "/empresa-distribuicao/:id",
  empresa_distribuicao_controllers.update
);
router.delete(
  "/empresa-distribuicao/:id",
  empresa_distribuicao_controllers.delete
);
...
router.post("/solicitacao", solicitacao_controllers.createNewSolicitation);
router.get("/solicitacao", solicitacao_controllers.readAll);

router.get(
  "/solicitacao-solicitado",
  middleware.authUser,
  solicitacao_controllers.solicitado
);
router.get(
  "/solicitacao-em-andamento",
  middleware.authUser,
  solicitacao_controllers.em_andamento
);
router.get(
  "/solicitacao-entregue",
  middleware.authUser,
  solicitacao_controllers.entregue
);
...
router.get(
  "/solicitacao-estatistica",
  middleware.authUser,
  solicitacao_controllers.estatisticasSolicitacoes
);

router.post(
  "/solicitacao-upload",
  middleware.authUser,
  solicitacao_controllers.xmlReader
);
/**
 * * Veiculo Routes
 */
